...
export async function getCastingCallBySlug(slug: string): Promise<CastingCallDetail | null> {
  ...
  try {
    ...
    return {
      ...
      auditionDeadline: raw.auditionDeadline ?? (raw.audition_deadline as string) ?? null,
      location: raw.location as string | null,
      director: raw.director as string | null,
      filmingDates: (raw.filmingDates ?? raw.filming_dates) as string | null,
      description: raw.description as string | null,
      submissionDetails: (raw.submissionDetails ?? raw.submission_details) as string | null,
      sourceLink: (raw.sourceLink ?? raw.source_link) as string | null,
